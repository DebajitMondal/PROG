...
var WON
var trail , trailImg , trailnp , trailnpImg , trailground , trailgroundImg , trailbg , trailbgImg , trailbuilding , trailbuildingImg;
var Title , TitleImg;
function preload() {
  ...
  OpPlr1Img = loadAnimation("unnamed5.png","unnamed2.png","unnamed6.png","unnamed2.png","unnamed5.png")
  OpPlr2Img = loadAnimation("unnamed5.png","unnamed2.png","unnamed6.png","unnamed2.png","unnamed5.png")
  OpPlr3Img = loadAnimation("unnamed5.png","unnamed2.png","unnamed6.png","unnamed2.png","unnamed5.png")
  ...
  trailImg = loadAnimation("unnamed.png","unnamed3.png","unnamed4.png","unnamed3.png","unnamed.png")
  trailnpImg = loadAnimation("policeman_PNG89033.png","policeman_PNG89.png","policeman.png","policeman_PNG89.png","policeman_PNG89033.png")
  ...
  trailbgImg = loadImage("imag.png")
  trailbuildingImg = loadImage("dsgsg.png")
  TitleImg = loadImage("NAME.png")
}
...
function setup() {
 ...
 trailbg = createSprite(windowWidth/2 , 200,20,20)
  trailbg.addImage("BG",trailbgImg)
  bg.scale = 2;

  trailbuilding = createSprite(displayWidth/2,200,20,20)
 trailbuilding.addImage("BUILDING", trailbuildingImg)

 trailground = createSprite(displayWidth/2,390,20000,20)
 trailground.shapeColor = "yellow"
 
 trail = createSprite(-30,trailground.y-60,10,10)
 trail.addAnimation("Trail",trailImg)
 trail.scale = 0.25
 
 trailnp = createSprite(-100,trailground.y-60,10,10)
 trailnp.addAnimation("Trailnp",trailnpImg)
 trailnp.scale = 0.2
 trail.velocityX = 8;
 trailnp.velocityX = 7;
 ...
 trailnp.visible = false
 trail.visible = false
 trailbg.visible = false
 trailbuilding.visible = false
 
 Title = createSprite(windowWidth/2.26,windowHeight/4.3)
...
function draw() {
 ...
 if(GameState === 1){
  ...
  OpPlr3.visible = false;
  trail.visible = true;
  trailnp.visible = true;
  trailbg.visible = true;
  trailbuilding.visible = true;
  Title.visible = true;
  Restart.hide();
  ...
  if(GameState === 2 ){
   ...
   if(Sate === 2){
    ...
    // music();
     ...
     if(touches.length>0 || keyDown("space")  && player.y >= 326){
        player.velocityY = -23;
